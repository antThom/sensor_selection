...
class TREE(STATIC_OBJECT):
    def __init__(self,loader,config=None,pos_type=None, pos_val=None, N=1, terrain=None, render=None):
    ...
    def _set_init_position(self, pos=None, min_point = None, max_point = None, on_ground = False):
