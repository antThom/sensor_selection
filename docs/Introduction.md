...
```bash
python sensor_selection_simulator.py --config <path/to/scene/config/>
```
...
You can change the setting of a value in a higher configuration file. This allows for the usage of the same configuration file as a template while changing aspects later in the configuration. Configurations lower down the hierarchy are applied first, and ones higher up the hierarchy are applied last.
...
You can change the setting of a value in a higher configuration file. This allows for the usage of the same configuration file as a template while changing aspects later in the configuration.
